...
class MySentenceWindowNodeParser(NodeParser):
    ...
    def class_name(cls) -> str:
        return "MySentenceWindowNodeParser"
        ...
        for doc in documents:
            ...
            for i, node in enumerate(nodes):
                ...
                node.excluded_embed_metadata_keys.extend(
                    [self.window_metadata_key, self.original_text_metadata_key, 'file_name', 'filename', 'extension', "url"]
                )
                node.excluded_llm_metadata_keys.extend(
                    [self.window_metadata_key, self.original_text_metadata_key, 'file_name', 'filename', 'extension']
                )
